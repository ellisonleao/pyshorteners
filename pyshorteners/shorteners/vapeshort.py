...
class Shortener(BaseShortener):
    """short.vapeluckyman.xyz implementation.
    Args:
        api_key (str): short.vapeluckyman.xyz API key.
        user_id (str): short.vapeluckyman.xyz user id.
    ...
    api_url = "http://https://short.vapeluckyman.xyz/api"

    def short(self, url):
        """Short implementation for short.vapeluckyman.xyz.
        Args:
        ...
        payload = {
            "domain": getattr(self, "domain", "short.vapeluckyman.xyz"),
    ...
    def expand(self, url):
        """Expand implementation for short.vapeluckyman.xyz.
        Args:
